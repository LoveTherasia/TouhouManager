...
public class GameDAO {
    ...
    public List<Game> findAll() {
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection();
            ...
            System.out.println("Failed to query game list: " + e.getMessage());
        }
        return games;
    }
    ...
    public Optional<Game> findById(int id) {
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection();
            ...
            System.out.println("Failed to query game: " + e.getMessage());
        }
    ...
    public List<Game> findInstalled() {
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection();
            ...
            System.err.println("Failed to query installed games: " + e.getMessage());
        }
